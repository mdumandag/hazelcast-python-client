...
from hazelcast.config import _IndexUtil, IndexType, _IndexConfig
...
class Map(Proxy):
    ...
    def add_index(self, attributes=None, index_type=IndexType.SORTED, name=None, bitmap_index_options=None):
        ...
        config = _IndexConfig.from_dict(d)
        validated = _IndexUtil.validate_and_normalize(self.name, config)
