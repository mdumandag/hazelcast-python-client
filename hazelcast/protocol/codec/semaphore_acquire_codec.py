...
# hex: 0x0C0200
_REQUEST_MESSAGE_TYPE = 786944
# hex: 0x0C0201
_RESPONSE_MESSAGE_TYPE = 786945
...
_REQUEST_TIMEOUT_MS_OFFSET = _REQUEST_PERMITS_OFFSET + INT_SIZE_IN_BYTES
_REQUEST_INITIAL_FRAME_SIZE = _REQUEST_TIMEOUT_MS_OFFSET + LONG_SIZE_IN_BYTES
_RESPONSE_RESPONSE_OFFSET = RESPONSE_HEADER_SIZE


def encode_request(group_id, name, session_id, thread_id, invocation_uid, permits, timeout_ms):
